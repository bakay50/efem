...
com {
    webbfontaine {
        efem {
            printea {
                stamppath =  'reports/images/'
                startstampdate =  '15/02/2022'
            }
            erc {
                retrieveAvd {
            ...
            exchange {
                ...
                fieldsConfig {
                    ...
                    exchangeAuhorization {
                        ...
                        countryOfDestinationCode =          ['M','O','P','P','P','P','O','P','P','P','P']
                        dateOfBoarding =                    ['P','P','P','P','P','P','P','P','P','P','P']
                        nationalityCode =                   ['M','M','P','P','P','P','M','P','P','P','P']
                        resident =                          ['M','O','P','P','P','P','O','P','P','P','P']
                        ...
                        declarantNameAddress =              ['P','P','P','P','P','P','P','P','P','P','P']

                        declarantCode =                     ['C','P','P','P','P','P','P','P','P','P','P']
                        beneficiaryName =                   ['O','O','P','P','P','P','O','P','P','P','P']
                        beneficiaryAddress =                ['O','O','P','P','P','P','O','P','P','P','P']
                        areaPartyCode =                     ['M','P','P','P','P','P','P','P','P','P','P']
                        countryPartyCode =                  ['M','O','P','P','P','P','O','P','P','P','P']
                    ...
                    /**
                     * Started Operation:
                     *  Index: 0  [CREATE, DECLARE, STORE, UPDATE_STORED, DECLARE_STORED] SN DN US
                     *  Index: 1 [DECLARE_QUERIED] DQ
                     *  Index: 4 [CONFIRM_DECLARED, CONFIRM] CD
                     *  Index: 6 [UPDATE_QUERIED] UQ
                     *  Index: 8 [UPDATE_CONFIRMED] UC
                     *  Index: 9 [DEFAULT]
                     */
                    repatriationAuhorization {
                        ...
                        natureOfFund =                      ['M','P','P','P','P','P','P','P','P','P']
                        ...
                        currencyCode =                      ['M','P','P','P','P','P','P','P','P','P']
                    ...
                    transferOrderAuhorization {
                        ...
                        executionDate =                     ['C','P','C','P','M','O','P','P','P','P']
                    ...
                    currencyTransferAuhorization {
                        ...
                        bankCode =                          ['P','P','P','P','P','P','P']
                        bankName =                          ['P','P','P','P','P','P','P']
                        currencyCode =                      ['P','P','P','P','P','P','P']
...
rest {
    ...
    notif {
        url="http://<host>/notifwbs/rest/notif/postparam"
    }
...
efemAllowedCheckingCurrencyCode {
    ...
    startingSearchRequestDate = '01/07/2021'
}
    ...
    operations{
        ...
        Update {
            ...
            endStatus = [
                    ...
                    "CEDED": [[recipient: 'bankAgent', mailType: "UPCLBA"]]
            ]
        }
    }
}
...
grails{
    mail{
        from="no-reply-qa@guce.gouv.ci"
        queueing=false
        to_admins {
            to = ['alex.zeboua@guce.gouv.ci', 'alex.zeboua@yopmail.com']
    ...
    webbfontaine{
        gws{
            integration{
                ...
                username = 'tvf'
                password = 'tvf'
                sendViaRestMethod = false
                hostname = 'localhost'
                virtualHost = 'emobile'
                exchange = 'gws.emobile'
                routingKey = 'gws.emobile.efem'



                transaction{
                    clazz = "com.webbfontaine.efem.log.ExchangeLog"
                    properties = [documentId: "exchange", initialStatus: "initialStatus",
                                  operation: "operation", endStatus: "endStatus",
                                  operationDate: "operationDate", userLogin: "userLogin"]
                }



                document{
                    clazz = "com.webbfontaine.efem.Exchange"
                    properties = ['status', 'requestType', 'basedOn', 'importerCode', 'countryProvenanceDestinationCode', 'currencyCode',
                                  'geoArea', 'treatmentLevel', 'balanceAs', 'amountNationalCurrency', 'authorizationDate', 'tvfNumber',
                                  'tvfDate', 'departmentInCharge', 'domiciliationDate', 'domiciliationBankCode', 'domiciliationNumber', 'declarantCode',
                                  'declarationSerial', 'declarationNumber', 'declarationDate', 'bankCode', 'bankName', 'registrationNumberBank',
                                  'registrationDateBank', 'requestNo', 'requestDate', 'version','exporterCode','clearanceOfficeCode']
                    allowedStatus = ['Queried', 'Partially Approved', 'Rejected', 'Approved', 'Cancelled', 'Executed']
                }
            }
        }
    }
