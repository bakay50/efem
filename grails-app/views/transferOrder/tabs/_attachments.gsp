<bootstrap:div id="'attDocListContainer">
    ...
    <table class="table table-bordered table-striped tableNoWrap" id="attDocTable">
        ...
        <g:if test="${transferInstance?.isAttachmentEditable()}">
            <tr id="addRow">
                <td></td>
                <td></td>
                ...
                <td><wf:datepicker name="docDate" maxDate="0" autoComplete="off" dateformat="${grails.util.Holders.config.bootstrapDate}" regexp="${'^[\\d /]+$'}" onkeydown="return false;"/></td>
                <td class="centered">
        ...
        <tbody id="attDocListBody">
            <g:render template="/attachedDoc/attachedDocList" model="[domainInstance:transferInstance]"/>
        </tbody>
    </table>
    ...
    <g:if test="${transferInstance?.isAttachmentEditable()}">
        <table id="editAttDocTable" style="display: none">
            <tr id="editAttDocRowContent">
                ...
                <td><wf:datepicker name="edDocDate" autoComplete="off" regexp="${'^[\\d/]+$'}" /></td>
                <td class="centered">
                    <a id="editUploadFile"
