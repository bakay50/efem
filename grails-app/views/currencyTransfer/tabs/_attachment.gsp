<bootstrap:div id="attDocListContainer">
    <bootstrap:div id="showwaybills" style="clear: both">
        <h3 id="titleListItems" style="float: left">
            <g:message code="attDoc.list_of_Attachments.label" default="List of Attachements"/>
        </h3>
...
<div id="alertInfo"></div>
    <table class="table table-bordered table-striped tableNoWrap" id="attDocTable">
        <thead>
            ...
            <g:if test="${currencyTransferInstance?.isAttachmentEditable()}">
                <tr id="addRow">
                    <td></td>
                    <td></td>
                    <td>
                        <wf:textInput id="docType" name="docType" value="" class="span1" maxlength="5" />
                    </td>
                    <td>
                        <wf:textInput id="docTypeName" name="docTypeName" value="" class="span2" maxlength="100" disabled="disabled"/>
                    </td>
                    <td>
                        <wf:textInput id="docRef" name="docRef" value="" class="span5" maxlength="35"/>
                    </td>
                    <td>
                        <wf:datepicker name="docDate" maxDate="0" dateformat="${grails.util.Holders.config.bootstrapDate}" regexp="${'^[\\d /]+$'}" onkeydown="return false;" />
                    </td>
                    <td class="centered">
                        <a id="addUploadFile" class="btn btn-default disabled" title="${message(code: 'attDoc.upload.label', default: 'Upload file')}">
        ...
        <tbody id="attDocListBody">
            <g:render template="/attachedDoc/attachedDocList" model="[domainInstance:currencyTransferInstance]"/>
        </tbody>
    </table>
