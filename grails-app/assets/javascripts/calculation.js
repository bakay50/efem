...
function doCalculateNationalAmount(){
    ...
    if ((request_Type=="EA" && basedOn == "TVF") ||(request_Type=="EC")){
        ...
        if (request_Type == "EC") {
            var isFinalAmount = $("#isFinalAmount").val().trim()
            if(isFinalAmount == false){
                $("#finalAmountInDevise").val($("#amountMentionedCurrency").val())
                formatElementsToString($("#finalAmountInDevise"))
                $("#finalAmount").val($("#amountNationalCurrency").val())
                $("#digitoperations").text($("#digitoperation").text())
            }
        }
    }else if(request_Type=="EA" && basedOn == "SAD"){
